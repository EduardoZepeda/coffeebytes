  ...
  return (
    <>
      ...
      >
        ...
        {showCookieOptions && <div><label><CookieOptions type='checkbox' checked value='site' disabled /> Cookies necesarias para el funcionamiento del sitio</label></div>}
        {showCookieOptions && <div><label><CookieOptions onChange={actions.theme.handleToggleAnalytics} type='checkbox' checked={state.analytics.pageviews.googleAnalytics} value='ga' /> Google analytics</label></div>}
      </CookieConsent>
    </>
  )
}
